<template>
  <div class="chat-wrapper">
    <div class="live-title">
      ...
      <span class="title-item active">直播互动</span>
    </div>
    <div id="message-send-box-wrapper" v-show="this.tabSelected ===0">
      ...
      <div class="send-header-bar">
        ...
        >
          <el-button slot="append" @click="sendTextMessage" round>发送</el-button>
        </el-input>
    ...
    <liveLike>
      <template slot-scope="{sendCustomMessage}">
        ...
        <img class="like-img cursor" @click="sendCustomMessage()" src="../../assets/image/like1.png"/>
      </template>
    </liveLike>
  ...
  export default {
    ...
    methods: {
      initListener() {
        ...
        // 收到自定义新消息
        this.im.off(this.TWebLive.EVENT.IM_CUSTOM_MESSAGE_RECEIVED, this.onCustomMessageReceived)

        this.im.on(this.TWebLive.EVENT.IM_CUSTOM_MESSAGE_RECEIVED, this.onCustomMessageReceived)
        // 收到文本新消息
        this.im.off(this.TWebLive.EVENT.IM_TEXT_MESSAGE_RECEIVED, this.onTextMessageReceived)
...
<style lang="stylus" scoped>
  ...
  .el-button--primary /deep/ {
    ...
    border-color rgb(245, 166, 35) //#2d8cf0
